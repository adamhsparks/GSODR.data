#' MODCF
#' @format A data frame with 23927 observations of 17 variables:
#' \describe{
...
#'
#' @references Wilson AM, Jetz W (2016). Remotely Sensed High-Resolution Global
#' Cloud Dynamics for Predicting Ecosystem and Biodiversity Distributions. PLoS
#' Biol 14(3): e1002415.
"MODCF"
